...
# -------------------------------
def run_random_forest(train_path, test_path, target_col="is_fraud", dataset_name="Dataset"):
...
# -------------------------------
# Run Random Forest on both datasets
# -------------------------------

# Dataset 1 uses 'Class' as target column
results_dataset_1 = run_random_forest(dataset_1_train_path, dataset_1_test_path, target_col="Class", dataset_name="Dataset 1")

# Dataset 2 uses 'is_fraud' as target column
results_dataset_2 = run_random_forest(dataset_2_train_path, dataset_2_test_path, target_col="is_fraud", dataset_name="Dataset 2")
