...
def run_dataset_1():
    print("\n--- Running Decision Tree on Dataset 1 (Credit Card Fraud Detection) ---")
...
def run_dataset_2():
    print("\n--- Running Decision Tree on Dataset 2 (Simulated Fraud Data) ---")
    ...
    print("Training model on Dataset 2...")
    start_train = time.time()
    clf.fit(X_train, y_train)
    end_train = time.time()
